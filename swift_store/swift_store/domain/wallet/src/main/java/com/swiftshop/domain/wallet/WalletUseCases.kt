...
interface WalletRepository {
    ...
    suspend fun initiateDeposit(userId: String, amount: MoneyAmount, gateway: String, provider: String, phone: String, idempotencyKey: String): Result<DepositInitiation>
    suspend fun verifyDeposit(sessionId: String): Result<Unit>
...
class VerifyDepositUseCase(private val repository: WalletRepository) {
    suspend operator fun invoke(sessionId: String): Result<Unit> =
        repository.verifyDeposit(sessionId)
}
