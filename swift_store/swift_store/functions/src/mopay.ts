...
export interface MopaySessionRequest {
    amount: string; // Documented as decimal string (e.g., "100.00")
    reference: string; // Alphanumeric only
    redirectUrl: string;
    description: string;
    customerEmail?: string;
    customerName?: string;
    notificationPhoneNumber?: string; // Merchant notification (omit in Sandbox)
}
